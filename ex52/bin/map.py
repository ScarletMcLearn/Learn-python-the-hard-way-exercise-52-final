...
laser_weapon_armory = Customroom("Laser Weapon Armory",
"""
...
get the bomb.  The code is 3 digits.""",rand = "".join([str(random.randint(0,9)) for i in range(3)]),count = 10)
...
escape_pod = Customroom("Escape Pod",
"""
...
laser_weapon_armory.add_paths({
    laser_weapon_armory.rand : the_bridge,
    '*': generic_death,
})
